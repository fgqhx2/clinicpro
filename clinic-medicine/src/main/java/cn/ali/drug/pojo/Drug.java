...
public class Drug {
    ...
    private Integer stock_max;//库存上限
    private Integer stock_min;//库存下限
    private String goods;//货位号
    private Integer period_warning;//有效期预警
    private String drug_explain;//药品说明
    ...
    public Integer getPeriod_warning() {
        return period_warning;
    }

    public void setPeriod_warning(Integer period_warning) {
        this.period_warning = period_warning;
    }

    public String getDrug_explain() {
        return drug_explain;
    }

    public void setDrug_explain(String drug_explain) {
        this.drug_explain = drug_explain;
    }
